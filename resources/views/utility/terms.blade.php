        ...
        <div class="my_row terms form_page">
            ...
            <div class="card guest">
                <div class="card-body">
                    ...
                    <p>
                        “Users(s)” refers to individual(s) or representative(s) of entities accessing and using LinkPro LLC’s Services through an account.
                    </p>
                    <p>
                        “Users Content” refers to all information, data, text, software, sound, photographs, graphics, messages, or other materials, whether stored, posted, uploaded, e-mailed, shared, or otherwise transmitted by Users (or End users) while using our Services.
                    </p>
                    <p>
                    ...
                    <p>
                        These Terms and Conditions are incorporated by reference into each Order Form submitted by Users. Together, these Terms and Conditions and the Order Form comprise a binding agreement between Users and LinkPro LLC, effective as of the date specified in the Order Form, and only as it pertains to Services provided pursuant to this specific Order Form and continuing for the term stated in the Order Form, unless terminated or canceled by LinkPro LLC or Users.
                    </p>
                    <h4 class="sub_title">3.2 License and Ownership</h4>
                    <p>
                        Subject to these Terms and Conditions, during the term of the applicable Order Form, we will provide Users (including their End Users) with a non-exclusive, revocable, non-transferable, and non-sublicensable license to use and have access to our Services as upgraded from time to time through your account. Except for the foregoing license, no other rights in the Services are granted to Users, and the Services (including the Website, their content with the exception of Users Content, features, functionalities, and any other materials provided by LinkPro LLC), shall remain the sole and exclusive property of LinkPro LLC and its licensors, if any, whether the Services are separate or integrated with any other products, services or deliverables. Users agree that their access or use of the Services is not contingent on the delivery of any future functionality or features, nor is it dependent on any public statements made by LinkPro LLC regarding future functionality or features.
                    </p>
                    <h4 class="sub_title">3.3 Account</h4>
                    <p>
                        To access and use LinkPro LLC’s Services, each Users shall have an account and take adequate safeguard measures to keep the user identification and password confidential. Cybersquatting is prohibited, and user identifications shall neither misappropriate nor infringe any third party’s IP rights and shall not be vulgar, obscene or offensive. To the extent legally permitted, Users will be held fully responsible for their own or third parties’ activities (such as IP violations, adverse impact on LinkPro LLC’s goodwill, or violation of applicable laws and regulations) that relate to the Users’ accounts. Without limiting its other remedies available at law, in equity or by statute, LinkPro LLC reserves the right to reallocate user identifications and to cancel or suspend a Users’s account if the Users does not comply with this Section. A Users may request the cancellation and/or deletion of their account at any time. LinkPro LLC will subsequently delete promptly and permanently Your Data except if otherwise instructed by the Users.
                    </p>
                    <p>
                        Each account shall have a unique Username for identification purposes, submitted by the Users. LinkPro LLC reserves the right to deny any Username, at it’s sole discretion, including, but not limited to, unavailability or offensiveness. LinkPro LLC shall not be responsible for providing justification to the Users for denial of any particular Username. <span class="text-decoration-underline">LinkPro also reserves the right to remove from LinkPro LLC’s platform  a Users’s account, at LinkPro’s Sole Discretion, at any time.</span> If a Pro or Premier Plan is taken down under said circumstances, then the Users shall receive a pro-rated refund of any amounts paid within sixty (60) days.
                    </p>
                    <h4 class="sub_title">3.4 Users Content</h4>
                    <p>
                        To the extent legally permitted, Users shall be fully liable for their Users Content (including the contents of their End Users). The Users Content is the sole property and responsibility of the Users. LinkPro LLC does not control Users Content posted via the Service and, as such, will not be liable in any way for any Users Content. Although we do not prescreen Users Content, we shall have the right (but not the obligation) in our sole discretion and without limiting others’ rights or remedies available to us, to refuse or remove any Users Content that is available via the Services if they are unlawful, unreliable, inappropriate, abusive, incite hatred, objectionable, or violate the privacy rights, publicity rights, contractual rights, IP rights or any other rights of any individuals or entities. Users warrant that they (or their End Users) have the right to use Users Content and grant LinkPro LLC a worldwide, royalty-free, transferable, irrevocable, and perpetual license to post, share, or otherwise transmit Users Content on the Website.
                    </p>
                    ...
                    <div class="indent">
                        ...
                        <p>
                            (vii) Be solely responsible for adequate security protection and backup of Your Data, Users Content, and/or equipment used in connection of the Services.
                        </p>
                        <p>
                    ...
                    <p>
                        Payment for Pro Plans and Premier Plans shall be made in advance and shall renew automatically unless canceled by Users at least one (1) day prior to the term. Excluding one-time discounts and promotional pricing, our price increase will not exceed one-hundred (100) percent. Users are responsible for providing complete and accurate billing and contact information to LinkPro LLC and for updating their accounts if such information changes. A Pro Plan or Premier Plan canceled by a Users will automatically convert to a Free Plan unless you request the deletion of your account.
                    </p>
                    ...
                    <p>
                        You agree to pay any and all reasonable attorney’s fees and/or collection costs incurred by LinkPro LLC in order to collect any fees or charges due following Users’s breach of the Payment section, including litigation expenses incurred in any legal proceedings.
                    </p>
                </div>
            </div>
        </div>
