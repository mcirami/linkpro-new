            ...
            <div className="my_row terms form_page">
                ...
                <div className="card guest shadow-md !mt-10 w-full">
                    <div className="card-body">
                        ...
                        <p className="blue_text bold_text mt-5">
